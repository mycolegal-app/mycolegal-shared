    ...
    extend: {
      ...
      colors: {
        mc: {
          ...
          /* Cian por token (mismos hex que `cyan` más abajo). */
          cyan: {
            50:  'var(--mc-cyan-50)',
            100: 'var(--mc-cyan-100)',
            200: 'var(--mc-cyan-200)',
          ...
          /* Color de ACCIÓN — sigue al logo de la app (Línea Oro = cian,
             Línea Plata = grafito). Usar SIEMPRE esto para botón primario,
             enlace en tabla, chip/pestaña activa, stepper y foco:
             `bg-mc-action-600 hover:bg-mc-action-700`, `text-mc-action-700`,
             `ring-mc-action-ring`. Ver tokens/colors.css. */
          action: {
            50:  'var(--mc-action-50)',
            100: 'var(--mc-action-100)',
            200: 'var(--mc-action-200)',
            300: 'var(--mc-action-300)',
            400: 'var(--mc-action-400)',
            500: 'var(--mc-action-500)',
            600: 'var(--mc-action-600)',
            700: 'var(--mc-action-700)',
            800: 'var(--mc-action-800)',
            900: 'var(--mc-action-900)',
            ring: 'var(--mc-action-ring)',
            soft: 'var(--mc-action-soft)',
            'on-dark': 'var(--mc-action-on-dark)',
            'on-dark-bg': 'var(--mc-action-on-dark-bg)',
          },
          'surface-soft': 'var(--mc-surface-soft)',
          app: {
