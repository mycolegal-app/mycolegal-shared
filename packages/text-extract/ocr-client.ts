...
//
// La app/servidor delega en platform el "leer texto de un escaneo" (PDF sin capa
// de texto o imagen) vía visión de Gemini. Así ninguna app embebe el acceso a
// Vertex. (Movido desde @mycolegal-app/sharedlib/ocr-client al consolidar la
